...
image = pd.read_csv("imageno.csv", dtype=str)
image = image.values.tolist()

sourceid = pd.read_csv("viewerid.csv", dtype=str)
sourceid = sourceid.values.tolist()
